...
for r = 1:nRow
    ...
    legend('t=0 s','t=1 s','t=2 s','t=3 s','t=4 s','t=5 s','t=6 s','t=7 s', 'Location','best')
    xlim([0 180])
end
...
for r = 1:nRow
    ...
    legend('t=0','MPP t=0', 't=1','MPP t=1', 't=2','MPP t=2', 't=3','MPP t=3', 't=4','MPP t=4', 't=5','MPP t=5', 't=6','MPP t=6', 't=7','MPP t=7', 'Location','best')
    xlim([0 180])
end

% Plot total maximum power point calue over time
figure
